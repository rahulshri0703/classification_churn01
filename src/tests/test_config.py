...
from churn_model.config.core import create_and_validate_config, fetch_config_file
import pytest
...
rename:
  ...
  jul_vbc_3g: vbc_3g_7
  jun_vbc_3g: vbc_3g_6
saved_model_name: stackingModelV1
saved_pipeline_name: pipeline_v1.pkl
final_pipeline: final_pipeline.pkl
x_test: x_test.csv
x_train: x_train.csv
y_test: y_test.csv
y_train: y_train.csv
...
def test_fetch_config_structure(tmpdir):
    ...
    config_1.write_text(TEST_CONFIG)
    parsed_config = fetch_config_file(cfg_path=config_1)
...
def test_config_missing_field_raise_error(tmpdir):

    config_dir = Path(tmpdir)
    config_1 = config_dir / 'sample_config.yaml'
    TEST_CONFIG_FILE = 'x_train : x_train.csv'
