...
class createFeatures(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        # Usage
        xx["delta_vol_3g"] = xx["vol_3g_mb_8"] - xx["vol_3g_mb_6"].add(
            xx["vol_3g_mb_7"]
        ).div(2)

        xx["delta_total_og_mou"] = xx["total_og_mou_8"] - xx["total_og_mou_6"].add(
            xx["total_og_mou_7"]
        ).div(2)

        xx["delta_total_ic_mou"] = xx["total_ic_mou_8"] - xx["total_ic_mou_6"].add(
            xx["total_ic_mou_7"]
        ).div(2)
        ...
        xx["delta_total_rech_amt"] = xx["total_rech_amt_8"] - xx[
            "total_rech_amt_6"
        ].add(xx["total_rech_amt_7"]).div(2)
